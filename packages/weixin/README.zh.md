...
| 包 | ctx 键 | 角色 |
|---|---|---|
| [`weixin`](weixin/README.md) | `ctx.weixin` | Service Definition + iLink 客户端 Provider：扫码登录、持久凭据、长轮询接收循环与文本发送 |
| [`weixin-agent`](weixin-agent/README.md) | — | Consumer：会话桥——入站消息唤醒专属 agent，其收尾的 assistant 文本回送给发信人 |
