...
export const zh = {
  ...
  'input.voiceDenied': '麦克风权限未授予：请在打开的授权页面或浏览器设置中允许使用麦克风，然后重试',
  'input.voiceError': '语音识别暂不可用',
...
export const en = {
  ...
  'input.voiceDenied': 'Microphone access is not granted: allow it on the opened grant page or in the browser settings, then retry',
  'input.voiceError': 'Speech recognition is unavailable right now',
