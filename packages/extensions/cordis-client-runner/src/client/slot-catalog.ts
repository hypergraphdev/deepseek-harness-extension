...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-weixin WeixinSection id \'messaging\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The team roster seat between the browsing region and the foot.',
    doc: 'The team roster seat between the browsing region and the foot.\nDeclared by this package\'s \'sidebar\' entry; ui-agents registers the\nHXA roster panel, which renders nothing while its source is dormant.',
    registerOptions: [],
    ownerProps: [
