...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  VisionBridgeRoute: 'llm-streaming.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  InboundText: 'inbound WeChat message record is owned by packages/weixin/weixin/README.md',
  WeixinStatus: 'link-state view for the settings panel is owned by packages/weixin/weixin/README.md',
  HxaEndpoint: 'resolved hub connection target is owned by packages/hxa/hxa/README.md',
  HxaBot: 'org roster record is owned by packages/hxa/hxa/README.md',
  HxaMessage: 'hub message record is owned by packages/hxa/hxa/README.md',
  HxaSendReceipt: 'send acknowledgement record is owned by packages/hxa/hxa/README.md',
  HxaCatchupCount: 'inbox catch-up count record is owned by packages/hxa/hxa/README.md',
  HxaCatchupPage: 'inbox catch-up page record is owned by packages/hxa/hxa/README.md',
